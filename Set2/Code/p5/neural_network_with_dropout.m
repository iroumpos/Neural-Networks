function neural_network_with_dropout(neurons, learning_rate,dropout_probability)
...
while (mse > tol && iter < max_iter)
  ...
  for P = -2:0.1:2
    ...
    dropout_mask = rand(neurons, 1) < dropout_probability;
    ...
    W2 = W2 - alfa * s2 * a1_dropout';
    W1 = W1 - alfa * s1 * P;
    b2 = b2 - alfa * s2;
    b1 = b1 - alfa * s1;
  end

  % Apply dropout mask to the forward propagation
  dropout_mask = rand(neurons, 1) < dropout_probability;
  a1_dropout = a1 .* dropout_mask;
